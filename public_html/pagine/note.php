...
$note = new db_manager($db_url, $db_username, $db_password, $db_name);
$ris = $note->vedi_note();
?>
...
<head>
    ...
    <title>Note - <?= $_SESSION['utente']['nome'] . " " . $_SESSION['utente']['cognome'] ?></title>
    ...
    <?php
    require_once('../../tmp/output/style_note.php')
    ?>
</head>
...
<body id="page-top">
    ...
    require_once('../../tmp/output/content_note.php');
